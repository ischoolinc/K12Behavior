    ...
    public partial class ClearDemeritConfigForm : BaseForm
    {
        ...
        private void linkDef1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            if (sfd.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    ...
                    fs.Write(Properties.Resources.銷過通知單_住址中間範本, 0, Properties.Resources.銷過通知單_住址中間範本.Length);
                    fs.Close();
        ...
        private void linkDef2_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            if (sfd.ShowDialog() == DialogResult.OK)
            {
                ...
                {
                    FileStream fs = new FileStream(sfd.FileName, FileMode.Create);
                    fs.Write(Properties.Resources.銷過通知單, 0, Properties.Resources.銷過通知單.Length);
                    fs.Close();
                    System.Diagnostics.Process.Start(sfd.FileName);
                }
                catch
        ...
        private void buttonX1_Click(object sender, EventArgs e)
        {
            ...
            ConfigData cd = K12.Data.School.Configuration["銷過通知單_ForK12"];
