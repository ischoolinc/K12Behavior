...
{
    internal class Attendance_islo : SmartSchool.Customization.Data.StudentExtension.AttendanceInfo
    {
        ...
        public Attendance_islo(int schoolyear, int semester, DateTime occurdate, string period, string periodtype, string absence, XmlElement detail)
        {
