...
namespace K12.Student.SpeedAddToTemp
{
    ...
    class StudentSortObj_SHSchoolData
    {
        ...
        public StudentSortObj_SHSchoolData(ClassRecord classRecord,StudentRecord student)
        {
            string ClassYear = ""; //年級
        ...
        public string Year(ClassRecord _class)
        {
            string classYear = "";
        ...
        public string Index(ClassRecord _class)
        {
            string classIndex = "";
