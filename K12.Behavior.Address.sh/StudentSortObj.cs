...
namespace K12.Behavior.Address.sh
{
    ...
    //class StudentSortObj_JHSchool
    //{
    //    public JHSchool.StudentRecord _StudentRecord { get; set; }
    //    public JHSchool.ClassRecord _ClassRecord { get; set; }
    //    public string _SortString { get; set; }

    //    public StudentSortObj_JHSchool(JHSchool.StudentRecord student)
    //    {
    //        string ClassYear = ""; //年級
    //        string ClassIndex = ""; //班級序號
    //        string ClassName = ""; //班級名稱
    ...
    //        #region ClassIndex & ClassName
    //        if (student.Class != null) //如果有班級
    //        {
    //            _ClassRecord = student.Class;
    //            ClassYear = Year(_ClassRecord);
    //            ClassIndex = Index(_ClassRecord);
    //            ClassName = _ClassRecord.Name.PadLeft(10, '0');
    //        }
    ...
    //        StudentSeatNo = !string.IsNullOrEmpty(_StudentRecord.SeatNo)?
    //            _StudentRecord.SeatNo.PadLeft(10, '0') :
    //            _StudentRecord.SeatNo.PadLeft(10, '9');

    //        _SortString = ClassYear + ClassIndex + ClassName + StudentSeatNo + StudentName;
    //    }

    //    public string Year(JHSchool.ClassRecord _class)
    //    {
    //        string classYear = "";

    //        if (!string.IsNullOrEmpty(_class.GradeYear))
    //        {
    //            classYear = _class.GradeYear.PadLeft(10, '0');
    //        }
    //        else
    //        {
    //            classYear = classYear.PadLeft(10, '9');
    ...
    //    public string Index(JHSchool.ClassRecord _class)
    //    {
    //        string classIndex = "";
